export const arRecipes: Record<string, {
  ...
  "morn-01": {
      ...
      "cuisine": "التغذية الشمسية الكلاسيكية",
      "instructions": [
